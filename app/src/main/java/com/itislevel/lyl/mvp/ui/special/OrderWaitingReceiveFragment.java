 ...
 */
public class OrderWaitingReceiveFragment extends RootFragment<SpecialPresenter>
    ...
    public OrderWaitingReceiveFragment() {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_order_waiting_receive;
    }
...
//        loadData();
    ...
    private void loadData() {
        ...
        request.put("status", Constants.SPECIAL_ORDER_SENDED + "");
    ...
    private void initAdapter() {
        if (adapter == null) {
            adapter = new SpecialOrderOtherAdapter(R.layout.item_order_watingreceive);
