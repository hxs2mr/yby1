...
public class FollowReplayItemBean implements MultiItemEntity {
    ...
    /*
    *  FollowReplayItemBean(item.getId(),item.getShareid(),item.getUserid(),
                    item.getTouserid(),item.getObserver(),item.getAnswerer()+"",
                    item.getShareid()+"",item.getComment(),
                    item.getFabulous()+"",item.getCreatedtime(),item.getModename());
    * */

    public FollowReplayItemBean(int id, int shareid, int userid, int touserid,String observer, Object answerer,String comment, String fabulous, Long createdtime, String modelname) {
        this.id = id;
        this.shareid = shareid;
        this.userid = userid;
        this.touserid = touserid;
