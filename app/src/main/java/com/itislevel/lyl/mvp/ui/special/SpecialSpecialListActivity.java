...
public class SpecialSpecialListActivity extends RootActivity<SpecialPresenter> implements SpecialContract.View {



    @Override
    protected int getLayoutId() {
        return R.layout.activity_special_special_list;
    }

    @Override
    protected void initEventAndData() {
        setToolbarTvTitle("特产列表");
    }
