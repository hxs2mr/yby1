...
import com.itislevel.lyl.adapter.FamilyTonListAdapter;
...
public class FTonCityFragment extends RootCancleFragment<FTonCityPresenter>
        implements FTonCityContract.View,
    ...
    private FamilyTonListAdapter adapter;
    ...
    private void initAdapter() {
        if (adapter == null) {
            adapter = new FamilyTonListAdapter(R.layout.item_family);
    ...
    @Override
    public void firstPage(FamilyTonListBean funsharingListBeans) {
...
//返回的数据 第一次
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        FamilyTonListBean.ListBean item = this.adapter.getItem(position);
