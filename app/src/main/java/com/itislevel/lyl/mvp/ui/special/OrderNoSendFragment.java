 ...
 */
public class OrderNoSendFragment extends RootFragment<SpecialPresenter>
    ...
    protected int getLayoutId() {
        return R.layout.fragment_order_no_send;
    }
...
//        loadData();
    ...
    private void loadData() {
        ...
        request.put("status", Constants.SPECIAL_ORDER_PAYED + "");
    ...
    private void initAdapter() {
        if (adapter == null) {
            adapter = new SpecialOrderOtherAdapter(R.layout.item_order_nosend);
