...
public class LivingPropertyActivity extends RootActivity<LivingExpensesPresenter> implements
    ...
    protected int getLayoutId() {
        return R.layout.activity_living_property;
    }
    ...
    @OnClick({R.id.btn_property_query})
    public void click(View v){
        switch (v.getId()){
            case R.id.btn_property_query:
                ActivityUtil.getInstance().openActivity(LivingPropertyActivity.this,LivingPropertyQeruyActivity.class,bundle);
                break;
