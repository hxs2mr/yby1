...
@UseRxBus
public class TroubleAdviserAddActivity extends RootActivity<TroublesolutionPresenter> implements
    ...
    protected int getLayoutId() {
        return R.layout.activity_trouble_adviser_add;
    }
...
//        String title = bundle.getString(Constants.TROUBLE_TITLE);
        ...
        teamtype = bundle.getInt("teamtype");
...
//            LinearLayoutManager layoutManager = new LinearLayoutManager(this);
    ...
    private void addSelectImg() {
        ...
        selectImgBean.setImgUrl(R.mipmap.icon_img_add);
    ...
    private void openSelectDialog() {
        ...
        final ActionSheetDialog dialog = new ActionSheetDialog(TroubleAdviserAddActivity.this,
                stringItems, null);
        ...
        SimpleRxGalleryFinal.get().init(
                new SimpleRxGalleryFinal.RxGalleryFinalCropListener() {
                    ...
                    public Activity getSimpleActivity() {
                        return TroubleAdviserAddActivity.this;
                    }
...
//                            tempList.add(temp);
    ...
    private void addViewCount() {
        ...
        request.put("usernum", SharedPreferencedUtils.getStr(Constants.USER_NUM));
//        request.put("userid", SharedPreferencedUtils.getStr(Constants.USER_ID));
        request.put("firstcateid", bundle.getInt(Constants.TROUBLE_TEAM_TYPE_FIRST_ID));
        request.put("adviserid", bundle.getString("adviserid"));

        mPresenter.teamViewCount(GsonUtil.obj2JSON(request));
...
//                request.put("ordernum", "");

                request.put("firstcateid", bundle.getInt(Constants.TROUBLE_TEAM_TYPE_FIRST_ID));
                request.put("adviserid", bundle.getString("adviserid"));

                request.put("goodsbody", "用户提问");
                totalPrice = 5;
                request.put("payfee", totalPrice);
...
//                mPresenter.troubleAdd(GsonUtil.obj2JSON(request));
                mPresenter.teamProblemAdd(GsonUtil.obj2JSON(request));
...
//        addViewCount();
        // TODO: 2018-02-02 王传豪让删的

        loadingDialog.dismiss();

        bundle.putString(Constants.PAY_MODULE_NAME, Constants.CART_MODEL_ZIXUN);
        bundle.putString(Constants.PAY_ORDERNUM, message);
        bundle.putString(Constants.PAY_TOTALPRICE, totalPrice + "");
        bundle.putString(Constants.PAY_GOODS_DETAIL, "烦恼提问");
        bundle.putString(Constants.PAY_GOODS_DESC, "顾问咨询费");
        bundle.putInt(Constants.PAY_FROM_ACTIVITY, Constants.PAY_FROM_TROUBLE_ADD);

        ActivityUtil.getInstance().openActivity(TroubleAdviserAddActivity.this, PayInfoActivity
                .class, bundle);
    ...
    public void teamViewCount(String message) {
        ...
        RxBus.getInstance().post(RxBus.getInstance().getTag(TeamListActivity.class,
                RxBus.TAG_UPDATE), "refresh");

        Logger.w("viewcount:" + message);
    ...
    class EditTextChangeListener implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
            ...
            SpannableString emotionContent = SpanStringUtils.getEmotionContent(EmotionUtils
                            .EMOTION_CLASSIC_TYPE, TroubleAdviserAddActivity.this, et_content,
