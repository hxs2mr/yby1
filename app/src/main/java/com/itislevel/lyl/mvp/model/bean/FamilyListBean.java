...
public class FamilyListBean {
    ...
    public static class  ListBean {
         ...
         * nickname : 哈哈哈
         * sacrificenum : 0
         * imgurl : 56B057C6-A2D5-4AFF-BE5D-4B3E2A609316.jpg
         */
        ...
        public String getSacrificenum() {
            return sacrificenum;
        }

        public void setSacrificenum(String sacrificenum) {
