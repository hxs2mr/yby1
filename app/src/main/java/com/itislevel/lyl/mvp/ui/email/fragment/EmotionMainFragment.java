package com.itislevel.lyl.mvp.ui.email.fragment;
...
import com.itislevel.lyl.mvp.ui.email.adapter.HorizontalRecyclerviewAdapter;
import com.itislevel.lyl.mvp.ui.email.adapter.NoHorizontalScrollerVPAdapter;
import com.itislevel.lyl.mvp.ui.email.emotionkeyboardview.EmotionKeyboard;
import com.itislevel.lyl.mvp.ui.email.emotionkeyboardview.NoHorizontalScrollerViewPager;
import com.itislevel.lyl.mvp.ui.email.model.ImageModel;
import com.itislevel.lyl.mvp.ui.email.utils.EmotionUtils;
import com.itislevel.lyl.mvp.ui.email.utils.GlobalOnItemClickManagerUtils;
import com.itislevel.lyl.mvp.ui.email.utils.SharedPreferencedUtils;
...
public class EmotionMainFragment extends BaseFragment {
   ...
   // private ImageView bar_image_add_btn;
    public static Button bar_btn_send;
    ...
    private void replaceFragment(){
        ...
        for (int i=0;i<1;i++){
            ...
            EmotiomComplateFragment f2= (EmotiomComplateFragment) factory.getFragment(EmotionUtils.EMOTION_CLASSIC_TYPE);
            fragments.add(f2);
        }
        //切记这点传getChildFragmentManager()
