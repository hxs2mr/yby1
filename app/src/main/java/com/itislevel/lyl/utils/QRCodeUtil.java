 ...
 * path:com.itislevel.lyl.utils.QRCodeUtil
 **/
public class QRCodeUtil {
    /**
     * 生成一个二维码图像
     *
     * @param txt       传入的字符串，通常是一个URL
     * @param QR_WIDTH  宽度（像素值px）
     * @param QR_HEIGHT 高度（像素值px）
     * @return
     */
    public static final Bitmap create2DCoderBitmap(String txt, int QR_WIDTH,
                                                   int QR_HEIGHT) {
        try {
            // 判断URL合法性
            ...
            // 图像数据转换，使用了矩阵转换
            BitMatrix bitMatrix = new QRCodeWriter().encode(txt,
