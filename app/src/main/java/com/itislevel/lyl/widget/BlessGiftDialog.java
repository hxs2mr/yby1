...
public class BlessGiftDialog extends BottomBaseDialog<BlessGiftDialog> implements View
    ...
    public BlessGiftDialog(BlessingDetailActivity activity, View animateView, BlessGiftBean
    ...
    public BlessGiftDialog(Context context) {
        super(context);
    }
        ...
        if (shopcartlistBeanList != null) {
            for (BlessCartListBean.ShopcartlistBean cart : shopcartlistBeanList) {
                ...
                if (cart.getGoodsid() == giftid) {
                    ...
                    activity.dialogUpdateCart(cart);
//                    activity.dialogAddCart(cart);
        ...
        if (!isAdded) {
            ...
            activity.dialogAddCart(shopcartlistBean);
        }
