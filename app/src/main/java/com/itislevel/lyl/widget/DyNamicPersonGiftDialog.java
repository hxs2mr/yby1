...
public class DyNamicPersonGiftDialog extends BottomBaseDialog<DyNamicPersonGiftDialog> implements View
    ...
    public DyNamicPersonGiftDialog(Dynamic_personFragment findFragment, Context context, View animateView, BlessGiftBean
