package com.itislevel.lyl.widget.videorecord.shortvideo.editor.common.widget.layer;
...
public class TCLayerViewGroup extends FrameLayout implements View.OnClickListener {
    ...
    public interface OnItemClickListener {
        void onLayerOperationViewItemClick(TCLayerOperationView view, int lastSelectedPos, int
                currentSelectedPos);
    }
