...
public class DyNamicGiftDialog extends BottomBaseDialog<DyNamicGiftDialog> implements View
    ...
    public DyNamicGiftDialog(DFindFragment findFragment,Context context, View animateView, BlessGiftBean
    ...
    public DyNamicGiftDialog(Context context) {
        super(context);
    }
