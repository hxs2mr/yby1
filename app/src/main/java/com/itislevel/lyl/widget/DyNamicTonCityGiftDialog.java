...
public class DyNamicTonCityGiftDialog extends BottomBaseDialog<DyNamicTonCityGiftDialog> implements View
    ...
    public DyNamicTonCityGiftDialog(DTonCityFragment findFragment, Context context, View animateView, BlessGiftBean
    ...
    public DyNamicTonCityGiftDialog(Context context) {
        super(context);
    }
