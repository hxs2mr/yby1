 ...
 **/
public class DynamicToncityGiftAdapter extends BaseQuickAdapter<ListTonCityItemBean.GiftListBean, BaseViewHolder> {

    public DynamicToncityGiftAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, ListTonCityItemBean.GiftListBean item) {
