 ...
 **/
public class DynamicDetailGiftAdapter extends BaseQuickAdapter<BaseGiftBean, BaseViewHolder> {

    public DynamicDetailGiftAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, BaseGiftBean item) {
