 ...
 **/
@UseRxBus
public class DTonCityCommentAdapter extends BaseQuickAdapter<ListTonCityItemBean.ListCommentItemBean,
        BaseViewHolder> {

    Activity funsharingHomeActivity;
    private int fabuzheid;//发布者id

    public DTonCityCommentAdapter(int layoutResId, Activity activity, int fabuzheid) {
        super(layoutResId);
    ...
    @Override
    protected void convert(BaseViewHolder helper, ListTonCityItemBean.ListCommentItemBean item) {
