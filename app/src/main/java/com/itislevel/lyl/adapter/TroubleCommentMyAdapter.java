 ...
 **/
@UseRxBus
public class TroubleCommentMyAdapter extends BaseQuickAdapter<TroubleListBean.ListBean.CommentsBean,
        BaseViewHolder> {

    TroubleNormalMyActivity troublesolutionListActivity;


    public TroubleCommentMyAdapter(int layoutResId, TroubleNormalMyActivity activity) {
        super(layoutResId);
...
//        //回复列表
        ...
        if (comments1!=null&&comments1.size()>0){
            TroubleCommentReplayMyAdapter adapter=new TroubleCommentReplayMyAdapter(R.layout.item_comment_replay);
