 ...
 **/
public class DynamicFollowGiftAdapter extends BaseQuickAdapter<ListItemBean.GiftListBean, BaseViewHolder> {

    public DynamicFollowGiftAdapter(int layoutResId) {
        super(layoutResId);
    }
