 ...
 **/
public class FamilyListAdapter extends BaseQuickAdapter<FamilyListBean.ListBean,
        BaseViewHolder> {
    public FamilyListAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, FamilyListBean.ListBean item) {
