 ...
 **/
public class DynamicGiftFollowAdapter extends BaseQuickAdapter<ListItemBean.GiftListBean, BaseViewHolder> {

    public DynamicGiftFollowAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, ListItemBean.GiftListBean item) {
