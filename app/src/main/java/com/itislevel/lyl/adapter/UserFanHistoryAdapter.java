 ...
 **/
public class UserFanHistoryAdapter extends BaseQuickAdapter<UserHistoryBean.ListBean,
        BaseViewHolder> {
    public UserFanHistoryAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper,UserHistoryBean.ListBean item) {
