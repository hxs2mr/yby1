 ...
 **/
@UseRxBus
public class DYPersonCommentAdapter extends BaseQuickAdapter<ListPersonBean.ListCommentItemBean,
        BaseViewHolder> {
    ...
    public DYPersonCommentAdapter(int layoutResId, Activity activity, int fabuzheid) {
        super(layoutResId);
    ...
    @Override
    protected void convert(BaseViewHolder helper, ListPersonBean.ListCommentItemBean item) {
