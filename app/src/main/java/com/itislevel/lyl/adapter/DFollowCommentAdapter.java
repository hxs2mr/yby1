 ...
 **/
@UseRxBus
public class DFollowCommentAdapter extends BaseQuickAdapter<ListItemBean.ListCommentItemBean,
        BaseViewHolder> {

    Activity funsharingHomeActivity;
    private int fabuzheid;//发布者id

    public DFollowCommentAdapter(int layoutResId, Activity activity, int fabuzheid) {
        super(layoutResId);
    ...
    @Override
    protected void convert(BaseViewHolder helper, ListItemBean.ListCommentItemBean item) {
