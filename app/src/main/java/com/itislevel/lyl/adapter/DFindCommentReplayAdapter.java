 ...
 **/
public class DFindCommentReplayAdapter extends BaseQuickAdapter<ListCommentItemBean,
        BaseViewHolder> {
    private int fabuzheid;//发布者id

    public DFindCommentReplayAdapter(int layoutResId, int fabuzheid) {
        super(layoutResId);
...
//        helper.setText(R.id.tv_replay,item.getComment());
        ...
        if(item.getComment().contains("数量"))
        {
