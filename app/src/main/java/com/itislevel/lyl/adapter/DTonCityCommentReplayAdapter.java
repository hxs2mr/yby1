 ...
 **/
public class DTonCityCommentReplayAdapter extends BaseQuickAdapter<ListCommentItemBean,
        BaseViewHolder> {
    private int fabuzheid;//发布者id

    public DTonCityCommentReplayAdapter(int layoutResId, int fabuzheid) {
        super(layoutResId);
