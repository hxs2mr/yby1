 ...
 **/
public class DynamicGiftPersonAdapter extends BaseQuickAdapter<ListPersonBean.GiftListBean, BaseViewHolder> {

    public DynamicGiftPersonAdapter(int layoutResId) {
        super(layoutResId);
    }
    @Override
    protected void convert(BaseViewHolder helper, ListPersonBean.GiftListBean item) {
