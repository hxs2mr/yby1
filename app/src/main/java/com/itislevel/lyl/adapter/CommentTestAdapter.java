...
public class CommentTestAdapter extends BaseMultiItemQuickAdapter<MeiZiMultipleBean, BaseViewHolder> {
     ...
     */
    public CommentTestAdapter(List<MeiZiMultipleBean> data) {
        super(data);
