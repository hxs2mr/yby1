 ...
 **/
public class BlessReceiveGiftListAdapter extends BaseQuickAdapter<BlessReceiveGiftBean.ListBean, BaseViewHolder> {

    public BlessReceiveGiftListAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, BlessReceiveGiftBean.ListBean item) {
        //  tv_name tv_time tv_goods_name iv_goods
