 ...
 **/
public class FamilyTonListAdapter extends BaseQuickAdapter<FamilyTonListBean.ListBean,
        BaseViewHolder> {
    public FamilyTonListAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, FamilyTonListBean.ListBean item) {
