 ...
 **/
public class FamilyFollowListAdapter extends BaseQuickAdapter<FamilyFollowListBean.ListBean,
        BaseViewHolder> {
    public FamilyFollowListAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, FamilyFollowListBean.ListBean item) {
